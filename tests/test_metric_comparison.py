...
class MetricComparisonTests(unittest.TestCase):
    ...
    def test_builder_authenticates_input_and_blocks_selection_claims(self) -> None:
        with tempfile.TemporaryDirectory() as temporary_directory:
            ...
            profiles_path = (
                processed_dir / "candidate_temporal_outcomes.parquet"
            )
            pq.write_table(
            ...
            summary_path = (
                quality_dir / "candidate_temporal_outcomes_summary.json"
            )
            ...
            marker_path = (
                metadata_dir
                / f"{recording_id}_candidate-temporal-outcomes_complete.json"
            )
