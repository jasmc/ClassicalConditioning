...
**Status:** Open draft — not Gate S  
**When:** Before locking confirmatory mixed-effects (or any other family)  
**Analog:** Learner workshop in `Plans/steps/11_LEARNER_CLASSIFICATION.md` §11.0  
...
that may fit the scientific estimand better. It does **not** approve a paper
model. Gate S still freezes the primary strategy after this workshop.
...
- `Plans/steps/10_STATISTICS_AND_SENSITIVITY.md`
...
> applied identically to all five candidate metrics.
