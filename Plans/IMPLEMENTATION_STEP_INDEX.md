...
| 10. Statistics and sensitivity | In progress | Step 09 and Gate S | Rendering from frozen synthetic results | **Done:** exploratory workshop; model-input; LME; fish-permutation; fish-bootstrap. **Open:** Gate O/S decisions, frozen cohort, condition-aware contrasts, outcome alignment, fit validity, and confirmation tests; see [readiness memo](./ANALYSIS_READINESS_DISCUSSION.md) |
