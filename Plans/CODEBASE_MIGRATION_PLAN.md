...
> **Implementation authority:** This document remains a detailed source plan.
> Active implementation sequencing, local-only execution, storage formats,
> figure modes, versioning, and completion workflow are governed by
> `MASTER_ANALYSIS_MIGRATION_PLAN.md` and
> `IMPLEMENTATION_STEP_INDEX.md`. Where they differ, the master plan
> takes precedence.
