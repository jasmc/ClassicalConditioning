...
**Status:** In progress (workshop + scaffold; not Gate S)  
**Change class:** Behavior-preserving legacy branch plus approved scientific correction  
...
[STATISTICS_METHODOLOGY_WORKSHOP.md](../Notes/STATISTICS_METHODOLOGY_WORKSHOP.md).
...
- choose one engineering default for shared five-metric plumbing and at least
