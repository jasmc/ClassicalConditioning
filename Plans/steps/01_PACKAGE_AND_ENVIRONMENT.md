...
or an equivalent single selected runner. Avoid parallel testing frameworks.
...
baseline in this exact environment. Step 05 numerical and Boolean-mask
equivalence uses this pinned reference, while the original environment run
remains an environment-drift comparison.
...
- [ ] A pinned-environment numerical reference is available for Step 05.
