...
> implemented only if the governing method review supports it.
...
Final learner-method selection begins after corrected preprocessing, cohort,
outcomes, and the necessary population-analysis contract are frozen. Begin with
an end-to-end scientific design review rather than choosing among the existing
scripts by default.
