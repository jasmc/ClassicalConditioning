...
more detailed [analysis files index](01_ANALYSIS_FILES_INDEX.md) and the
[analysis findings audit](../audits/01_ANALYSIS_FINDINGS.md).
...
`docs/analysis/legacy/04_LEARNER_VARIANT_BEHAVIOR_MATRIX.md`.
