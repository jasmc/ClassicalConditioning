...
| [`supplementary`](../../../outputs/figure2-delay/supplementary/) | Historical contributing-fish coverage / cohort fish, 0…1 `cividis`. New aligned coverage uses `managua_r` on its own 0…1 fraction scale. | Figure 2 coverage supplement, separate from main A. |
