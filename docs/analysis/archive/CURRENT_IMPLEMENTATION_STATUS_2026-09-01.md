...
immutable TXT acquisition
  ...
  -> three-metric recording/cohort comparison
...
- `figure-metric-comparison` plots fish points and equal-recording mean bars of
  **standardized difference** for the three candidate metrics.
...
| Caveat | This run predates the current three-metric shortlist and must be regenerated |
