...
This folder documents the current analysis architecture and behavior, records
...
- [Pipeline and heatmap audit](./audits/PIPELINE_AND_HEATMAP_AUDIT.md)
...
Snapshots are retained for provenance but are not updated and are not current
status authority.
