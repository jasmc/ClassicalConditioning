...
| Analysis workflow launchers | `complete-allDelay-to-lme-windows.ps1`, `resume-allDelay-full-windows.ps1`, `run-allDelay-full-windows.ps1`, `run_allDelay_refactor_smoke.sh` | These operate the analysis pipeline rather than render paper panels. |
