...
Historical transfer instructions. For the current delay analysis, metric and
learner-rule review, and Figure 4 readiness, see
[`DELAY_FIGURE4_READINESS_2026-09-24.md`](docs/analysis/figures/DELAY_FIGURE4_READINESS_2026-09-24.md).
...
This repository is the authoritative codebase. The relevant fixes are already
committed:
...
The completed 57-fish project is `J:\Digested Data\allDelay-full-v1`.
Preserve its per-fish artifacts and full-cohort results.
...
3. On the Windows computer, use 64-bit Python **3.12 or 3.13**. Python 3.14 is
   currently unsupported by the Parquet stack.
4. Reserve at least **500 GB free space** on the drive holding the new output
...
Use `configs\allDelay-full-v1-cohort.csv` as the column-format example:
...
* Preserve `J:\Digested Data\allDelay-full-v1` in place; do not delete or
  overwrite it.
